...
public:
    ...
    ogg(const std::string filepath) : audio(filepath)
    {}

    ogg(std::ifstream & bytestream) : audio(bytestream)
    {}
...
public:
    ...
    nao_single_channel_wav(const std::string filepath) : audio (filepath)
    {}

    nao_single_channel_wav(std::ifstream & bytestream) : audio (bytestream)
    {}
...
public:
    ...
    nao_quad_channel_wav(const std::string filepath) : audio (filepath)
    {}

    nao_quad_channel_wav(std::ifstream & bytestream) : audio (bytestream)
    {}
...
public:
    ...
    microphone_wav(const std::string filepath) : audio (filepath)
    {}

    microphone_wav(std::ifstream & bytestream) : audio (bytestream)
    {}
