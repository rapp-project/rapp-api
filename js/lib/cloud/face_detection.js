 ...
 * the fast face detection service is called, which should be used for 
 * tracking applications
 */
RAPPCloud.prototype.face_detection = function(
                                               image,
                                               image_format,
                                               callback,
                                               fast
                                             )
{
	...
	var r = request.post(
                          cloud.cloud_url + '/hop/face_detection/ ', 
		...
		try {
			...
			if(json_obj.error) {  // Check for Errors  
                ...
                /* JSON reply is eg.: 
                   { 
                     "faces":[{
                        "up_left_point":{"x":212.0,"y":200.0},
                        "down_right_point":{"x":391.0,"y":379.0}
                        }],
                     "error":""
                   }
                */
