...
RAPPCloud.object_detection_learn_object = require(path.join(__cloudDir, 'object_detection_learn_object.js'));
RAPPCloud.object_detection_clear_models = require(path.join(__cloudDir, 'object_detection_clear_models.js'));
RAPPCloud.object_detection_load_models = require(path.join(__cloudDir, 'object_detection_load_models.js'));
RAPPCloud.object_detection_find_objects = require(path.join(__cloudDir, 'object_detection_find_objects.js'));
