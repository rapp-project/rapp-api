...
describe('#QrCode()', function(){
	it('should construct a qr_code object when given the x and y centres and a label', function(){
		var qr_code = new objects.Qr_code(0.1, 0.1, "lazaros");
	});
});
...
describe('#qr_code.is_equal()', function(){
	it('should return true if and only if the label of the qr_code whose is_equal is a member function is equal to the label of the qr_code object given as an argument', function(){
		var qr_code1 = new objects.Qr_code(0.1, 0.1, "lazaros");
		var qr_code2 = new objects.Qr_code(0.1, 0.2, "lazaros");
		var qr_code3 = new objects.Qr_code(0.1, 0.1, "nao");
...
describe('#picture()', function() {
    it('should wrap around jpg and png encoded pictures given either as memory buffers or file paths', function() {
        var pic = new objects.picture('../testdata/cat.jpg');
        var pic2 = new objects.picture('../testdata/qrcode.png');
    });
});
