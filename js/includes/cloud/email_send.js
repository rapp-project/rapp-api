 ...
 * @param file(String): Path to a file attachment. Single file. In case of multiple attachments a zip file must be send to this field name.
 */

RAPPCloud.prototype.email_send = function ( email, passwd, server, port, recipients, body, subject, file )
{
