...
RAPPCloud.cognitive_test_chooser = require('../lib/cloud/cognitive_test_chooser');
RAPPCloud.cognitive_record_performance = require('../lib/cloud/cognitive_record_performance');
RAPPCloud.cognitive_get_history = require('../lib/cloud/cognitive_get_history');
RAPPCloud.cognitive_get_scores = require('../lib/cloud/cognitive_get_scores');
...
services.cognitive_record_performance("ReasoningCts_VeMDiXVm", 1, cb2);
