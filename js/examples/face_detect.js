...
RAPPCloud.face_detection = require('../lib/cloud/face_detection');
...
function handler(faces)
{
    if (faces.length)
    {
        for (var i=0;i<faces.length;i++)
        {
            ...
            console.log(
                         "up_left_point: {x: " + faces[i].get_up_left_x() + 
                         ", y: " + faces[i].get_up_left_y() + "}"
                       ); 
            console.log(
                         "down_right_point: {x: " + faces[i].get_down_right_x() + 
                         ", y: " + faces[i].get_down_right_y() + "}"
                       );
        }
    }
	else
